...
def main():
    ...
    with st.sidebar:
        st.title("Menu:")
        pdf_docs = st.file_uploader("Upload your Files and Click on the Process", accept_multiple_files=True)
    ...
    st.text_area("Extracted Text", get_pdf_text(pdf_docs) if pdf_docs else "No Document uploaded", height=300)
